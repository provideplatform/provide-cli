...
import (
	"github.com/provideplatform/provide-cli/prvd/axiom/participants"
	"github.com/provideplatform/provide-cli/prvd/axiom/systems"
...
var WorkgroupsCmd = &cobra.Command{
	Use:   "workgroups",
	Short: "Interact with axiom workgroups",
	Long:  `Create, manage and interact with workgroups via the axiom protocol.`,
